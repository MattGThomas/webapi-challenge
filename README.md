...
- [x] Mention two parts of Express that you learned about this week.
        ...
        express as a middle ware / router

- [x] Describe Middleware?

        middleware is a function that works between node and express, allowing you to manipulate data
        before it is used

- [x] Describe a Resource?

        an object with a type and data that has several standard methods that can be applied towards it 

- [x] What can the API return to help clients know if a request was successful?

        the api can return status codes / messages that will let a client know if the request was successful 
        or not

- [x] How can we partition our application into sub-applications?

        use middleware to have separate endpoints that work with different resources
